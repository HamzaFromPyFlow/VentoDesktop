...
import InputSettings from './record/InputSettings';
import CameraOnlyRecordingToolbar from './record/CameraOnlyRecordingToolbar';
  ...
  return (
    <>
      ...
      {recordingState !== 'recording-cam' && (
        <p className="mb-3 text-sm text-gray-700 text-center max-w-[600px] mx-auto px-4 md:px-6">
          An audio chime will play when recording starts! <strong>PS:</strong> Make sure your browser is up to date!
        </p>
      )}

      {/* InputSettings wrapper - matches original structure */}
